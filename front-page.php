...
<section class="landing-block">
    <div class="container fluid">
        ...
        <div class="media video-content">
            <video title="nowrx pharmacy delivery website video" class=" orbit-image" id="mainvideo"    preload="none">
            ...
            <div class="sliding-items">
                <div class="slider-main">
                    ...
                    <div class="float-icon-ri">
                            <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-New-Rx.svg" class="lozad" alt="ICO New Rx" height="36" width="36">
                        </div>
                        <span class="inline-title">Initiated By</span>
                        <div class="context-de">
                        <span class="icon">
                                <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Doctor.svg" class="pic limg lozad" style="max-width:26px;max-height:26px;" height="26" width="26" alt="ICO Doctor">
                            </span>
                            Doctor
                        </div>
                        ...
                        <div class="context">
                            <span class="line starred">
                                <div class="star-float">
                                    <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Star.svg" alt="ICO Star" class="lozad" height="18" width="18">
                                </div>
                                <span class="icon">
                                    <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Web.svg" class="pic limg lozad" style="max-width:26px;max-height:26px;" height="26" width="26" alt="ICO Web">
                                </span>
                                <span class="txt"><strong>ePrescribe</strong> - Tell your doctor to electronically prescribe to NowRx.</span>
                            </span>
                            <span class="line">
                                <span class="icon">
                                    <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Fax.svg" class="pic limg lozad" style="max-width:26px;max-height:26px;" height="26" width="26" alt="ICO Fax">
                                </span>
                    ...
                    <div class="slide">
                        <div class="float-icon-ri">
                            <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Transfer-Rx.svg" class="lozad" alt="ICO Transfer Rx" height="36" width="36">
                        </div>
                        <span class="inline-title">Initiated By</span>
                        <div class="context-de">
                            <span class="icon">
                        ...
                        <div class="context">
                            <span class="line starred">
                            <div class="star-float">
                            <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Star.svg" class="lozad" alt="ico star" height="18" width="18">
                                </div>
                                <span class="icon">
                                    <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Web.svg" class="pic lozad limg " style="max-width:26px;max-height:26px;" height="26" width="26" alt="ICO Web">
                                </span>
                            ...
                            <span class="line">
                                ...
                                <span class="icon">
                                    <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-Call-Text.svg" class="pic lozad limg " style="max-width:26px;max-height:26px;" height="26" width="26" alt="ICO Call Text">
                                </span>
                                <span class="txt"><strong>Call or Text</strong> - You can also call or text your local NowRx to get started.</span>
                            </span>
                            <span class="line">
                                <span class="icon">
                                    <img data-src="<?php echo get_template_directory_uri(); ?>/images/rx-icons/ICO-App.svg" class="pic lozad limg " style="max-width:26px;max-height:26px;" height="26" width="26" alt="ICO App">
                                </span>
