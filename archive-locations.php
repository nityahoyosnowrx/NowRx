            ...
            <div class="container">
                ...
                <header class="article-header tynk locations-header">
                    ...
                    <div class="imageblock">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/NowRx-National-Map-Big.png"
                            alt="NowRx Pharmacy locations map" width="300px" height="300px" class="pic">
                    </div>
                </header>
            </div>
                ...
                <div class="locatios-mainblock">
                    ...
                    <div class="location-item signup">
                        ...
                        <span class="desc-item" style="display:block;">
                            <a class="rx-btn" data-toggle="suggestalocation" aria-controls="suggestalocation"
                                aria-haspopup="true" tabindex="0">Suggest a Location</a>
                        </span>
                    </div>
...
function sanFranMap() {
    ...
    function initMap() {
        ...
        autocomplete.addListener('place_changed', function() {
            ...
            var newBounds = new google.maps.LatLngBounds(bounds.getSouthWest(), bounds
        .getNorthEast()); //Changed
