    ...
    <div class="article-data">
      ...
      <div itemprop="publisher" itemscope itemtype="http://schema.org/Organization" >
        ...
        <span itemprop="logo" itemscope itemtype="http://schema.org/ImageObject" >
          <link itemprop="url" href="https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" />
      ...
      <div class="articleheader-container" itemprop="author"   itemscope itemtype="http://schema.org/Person">
        ...
        <div class="author-info" >
          <span>
            <div class="author-portrait" itemprop="image"  style="background-image: url(https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260);"></div>
          </span>
    ...
    <?php if (has_post_thumbnail( $post->ID ) ): ?>
        ...
        <figure class="article-featured-image">
          ...
          <picture data-test="picture">
            ...
            <img src="<?php echo $image[0]; ?>" alt="" class="" itemprop="image">
          </picture>
