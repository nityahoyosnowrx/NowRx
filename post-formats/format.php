              ...
              <h1 class="entry-title single-title" rel="bookmark" itemprop="headline" rel="bookmark"><?php the_title(); ?></h1>



              </header> <?php // end article header ?>

              <article id="post-<?php the_ID(); ?>" <?php post_class('cf'); ?> role="article" role="article" itemscope itemprop="blogPost" itemtype="http://schema.org/BlogPosting">
                ...
                <div class="article-time">
                    ...
                    <div class="articleheader-container">
                      ...
                      <div class="author-info">
                        ...
                        <span>
                          <div class="author-portrait" style="background-image: url(https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260);"></div>
                        </span>
                        <div class="author-box">
                          <a href="mailto:<?php echo get_the_author_meta( 'email', $author_id ); ?>" class="author-name">
                    ...
                    <div class="share-to">
                      ...
                      <div class="social-icons">
                          <a href="http://twitter.com/share?text=share this article&url=<?php echo $current_slug = add_query_arg( array(), $wp->request ); ?>&hashtags=hashtag1,hashtag2,hashtag3" class="social-a">
