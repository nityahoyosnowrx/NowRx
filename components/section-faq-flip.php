<section class="block-frequent-questions">
        ...
        <div class="content">
            ...
            <div class="btn-container desktop">
                <a href="<?php echo get_site_url(); ?>/faqs/" class="rx-button rx-light">View all FAQs
                    <div class="icon">
                        <svg style="max-width:20px;height:20px;" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="arrow-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-arrow-right fa-w-14 fa-9x">
                        ...
                        <li class="list-item">
                            <div class="list-title">
                                ...
                                <div class="list-action" data-view="false">
                                    <div class="open">
                                        <svg style="max-width:20px;height:20px;" aria-hidden="true" focusable="false" data-prefix="far" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="svg-inline--fa fa-angle-down fa-w-10 fa-9x">
