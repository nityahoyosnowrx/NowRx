...
<section class="testimonials-block doctorquotes">
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="image">
                <figure>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/Best Prescription Delivery Service for Northern California and Orange County Residents.webp"
                        class="orbit-image lozad"
                        alt="nowrx pharmacy delivery happy customers celebrating low drug prices" data-loaded="true">
                </figure>
            </div>
        </div>
        <!-- end content -->
